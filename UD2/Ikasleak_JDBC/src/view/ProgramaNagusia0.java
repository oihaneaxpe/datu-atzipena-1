...
public class ProgramaNagusia0 extends Application {
   ...
   // textField2.setPromptText("ni textField1a naiz");
    textField3 = new TextField("127.0.0.1");
//    textField3.setPromptText("ni textField0a naiz");
    textField4 = new TextField("Ikasleak");
//    textField4.setPromptText("ni textField0a naiz");
    textField5 = new TextField("root");
//    textField5.setPromptText("ni textField0a naiz");
    textField6 = new TextField("root");
//    textField6.setPromptText("ni textField0a naiz");
